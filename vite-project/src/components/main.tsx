...
export const Main = (): JSX.Element => {
  ...
  const onSelectInput = (target: EventTarget) => {
      if (target instanceof HTMLSelectElement) setActiveTab(target.value);
  };
        ...
        return <main className="main">
            ...
            <section className="section main__devices">
                <div className="section__title">
                    ...
                    <select className="section__select" defaultValue="all" onInput={(e) => onSelectInput(e.target)}>
                        {TABS_KEYS.map(key =>
